        ...
        <div class="col-md-8">
            ...
            {{ csrf_field() }}
            	<label for="exampleInputEmail1">Titulo</label>
    				<input type="text" name="titulo" class="form-control" id="exampleInputEmail1" aria-describedby="tituloPost" placeholder="Titulo da publicação..." required>
            </div>
					<div class="form-group">
...
<input class="btn btn-primary" name="publicar" type="submit" value="Publicar" />
</form>
<!-- Modal -->
      ...
      <div class="modal-footer">
          ...
          <div class="card mb-4">
            ...
            <div class="card-footer text-muted">
              ...
              <a><?php $persona = \feederation\Persona::find($post->persona_id); echo $persona->nome . " " . $persona->sobrenome; ?></a>
            </div>
          </div>
			 @endforeach
        ...
        <div class="col-md-4">
          ...
          <div class="card my-4">					<!-- GL HF   -->
            <h5 class="card-header">GL HF, {{Auth::user()->nome}} {{Auth::user()->sobrenome}}</h5>
            <div class="card-body">
              <div class="row">
                <div class="col-lg-6">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                  <form method="post" action="/home/guilda/{{$nomeGuilda}}/adicionarMembro">
						{{ csrf_field() }}
						<input type="submit" name="procurarMembros" class="btn btn-primary" value="Procurar membros" />				
						</form>
                  </ul>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                  <form method="post" action="/home/guilda/{{$nomeGuilda}}/solicitacoesPersonas">
						{{ csrf_field() }}
						<input type="submit" name="procurarMembros" class="btn btn-primary" value="Candidatos" />				
						</form>
                  </ul>
                </div>
              </div>
              ...
              <div class="row">
              	<div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                  <form method="post" action="{{ url('/procurarGuilda') }}" class="form-inline my-2 my-lg-0">
  							{{ csrf_field() }}
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form method="post" action="{{url('solicitacoes')}}" class="form-inline my-2 my-lg-0">
						...
						@if ($temGuilda == FALSE)
                  <ul class="list-unstyled mb-0">
                  <form method="post" action="{{url('solicitacoesGuildas')}}" class="form-inline my-2 my-lg-0">
							{{ csrf_field() }}
