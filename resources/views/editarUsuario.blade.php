...
<html lang="en">
  ...
  <head>
    ...
    <title>Editar Usuario - Feederation</title>
...
<div class="main-div">
    <div class="panel">
   <h2>Atualizar suas informações</h2>
   <p>Altere os campos abaixo</p>
   </div>
    <form action="atualizarUsuario" method="get" id="Login">

        <div class="form-group">

				<input type="hidden" name="id" value="{{$user->id}}" />				
				
            <input name="nome" type="text" class="form-control" id="nome" value="{{$user->nome}}">
            ...
            <input name="sobrenome" type="text" class="form-control" id="sobrenome" value="{{$user->sobrenome}}">
