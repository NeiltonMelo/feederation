...
<html lang="en">
  ...
  <head>
    ...
    <title>Feederation - Cadastro de Guilda</title>
...
<div class="main-div">
    <div class="panel">
   <h2>Cadastro de Guilda</h2>
   <p>Preencha os campos abaixo</p>
   </div>
    <form method="post" action="inserirGuilda" id="Login">
    {{ csrf_field() }}
			<div>			
				<img src="img/guild_image.jpeg" class="img-fluid" alt="Responsive image">
   		</div>     
        <br>
        <div class="form-group">

            <input type="text" name="nome" class="form-control" id="nome" placeholder="Nome da guilda">
				
        </div>

        
        <input type="submit" name="criar" class="btn btn-primary" value="Criar Guilda" />
