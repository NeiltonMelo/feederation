...
<html lang="{{ app()->getLocale() }}">
	...
	<body>
		...
		<div class="container box">
			<h3 align="center"> Cadastro Jogo </h3>
			<br/>
			...
			<form method="post" action="inserirGame">
				...
				<div class="form-group">
					...
					<input type="text" name="classificacaoIndicativa" class="form-control" required value="" />
				</div>		
				
				<div class="form-group">
					<label>Data de Lancamento</label>
					<input type="date" name="lancamento" class="form-control" required value="" />
				</div>		
